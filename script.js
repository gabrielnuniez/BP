    ...
    function renderizarListaClientes(terminoBusqueda = "") {
        ...
        filtrados.forEach((c, index) => {
            ...
            if (c.telefono) {
                ...
                btnWsp = `<a href="https://wa.me/${telLimpio}" target="_blank" class="m3-icon-btn" style="background:var(--m3-surface-variant);" onclick="event.stopPropagation()"><span class="material-symbols-rounded" style="color:var(--m3-primary); font-size:20px;">chat</span></a>`;
            }
    ...
    function renderizarVistaHoy() {
        ...
        regHoy.sort((a,b) => (a.hora > b.hora ? 1 : -1)).forEach(r => {
            ...
            if (r.tipo === 'ingreso' && r.telefono) {
                ...
                btnWsp = `<a href="https://wa.me/${telLimpio}" target="_blank" class="wsp-btn" onclick="event.stopPropagation()"><span class="material-symbols-rounded" style="color:white; font-size:18px;">chat</span></a>`;
            }
